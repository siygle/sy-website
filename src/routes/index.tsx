  ...
  head: () => ({
    meta: [
      { title: "Sy Lee - Software Engineer" },
      {
        name: "description",
        content:
          "Personal website of a software engineer from Taiwan who is passionate about web development",
      },
    ],
  }),
      ...
      <section className="mt-16 sm:mt-32 mb-16">
        <div className="flex flex-col items-start">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 mb-4 max-w-2xl">
            ...
            , a software engineer from Taiwan who is passionate about web
            development. I love writing code and staying up-to-date with the{" "}
            <a href="https://chat.sylee.dev/" className="underline">
              latest web trends
            </a>
            .
          </p>
